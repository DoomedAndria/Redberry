...
const {listing, listings, getListing, getListings, deleteListing} = useListing()
...
<template>
  <div class="mt-10">
    ...
    <carousel class="mt-20" v-if="regionListings.length !==0" :listings="regionListings"/>
